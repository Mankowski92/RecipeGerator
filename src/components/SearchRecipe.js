...
const SearchRecipe = props => {
  ...
  const handleSubmit = e => {
    ...
    fetch(
      `https://api.spoonacular.com/recipes/search?query=${query}&cuisine=${cuisine}&diet=${diet}&excludeIngredients=${excludeIngredients}&intolerances=${intolerances}&number=${number}&apiKey=72537751dcd74f0cbe54623e5064fa3b`,
      {
        method: "GET",
        headers: {
